...
function boot() {
  ...
  if (stamp) stamp.textContent = `Build 8 · ${CLEAN_URL.replace('https://', '')}`;
...
function openInviteInstructions() {
  openModal(`
    ...
    <ol style="font-size:14px;line-height:1.7;padding-left:20px;margin:0 0 18px;">
      ...
      <li>They'll appear here automatically, inactive, named after their email</li>
      <li>Come back and click <strong>Edit</strong> to set their real name, role, home workshop, and mark them Active</li>
    </ol>
    <p style="font-size:13px;color:var(--ink-muted);margin:0 0 18px;">Tell them to sign in and change the temporary password from the account menu.</p>
